...
ax11 = sns.pointplot(x='time', y='name', hue='test', ax=ax11, data=df_ax11, order=yticks_name_order, markersize=5,markerscale=20, dodge=True, hue_order=hue_order)
# keep legend info
...
# plot times
sns.pointplot(x='time', y='name', hue='test', ax=ax12, data=df_ax12, order=yticks_name_order, markersize=5,markerscale=20, dodge=True, hue_order=hue_order)
# keep bounds
...
ax11.figure.savefig('Zarr_Read_Time_Comparison.png', bbox_inches='tight')
